...
(define-minor-mode atlas-mode
  "The purpose of this mode is to make text manipulation easier and also be able
to provide more varied keybindings. It'll allow movement of many sentences and
paragraphs without having to use convoluted keybindings that break your pinky.
Of course for simple manipulations, such as correcting 'theer' to 'there', would
just need a simple global or correcting it manually."
  :init-value nil
  :lighter " WYK"
  :keymap
  '(("C-M-w" . split-window-below))
...
(define-minor-mode eleanor-mode
  "This is mode creates an easier experience for managing
multiple windows once you enter the mode as you have access
to simple keybindings."
  :init-value nil
  :lighter " Lamb"
  :keymap
  '(("C-M-w" . split-window-below))
