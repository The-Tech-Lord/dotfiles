...
since I've kinda become a crack addict about it now haha. I also don't wanna have to pay for MS Word and LibreOffice's look kinda throws me off (still very good software
though!). SO I thought, "why not just make that in my own config?", and here we are.
