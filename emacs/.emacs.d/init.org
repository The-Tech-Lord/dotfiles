...
* Vigors
I love the Bioshock series and felt like naming the modes after characters or aspects of the Bioshock series.
Here's where we create a mode for everything. Some have useful shit while others are barely used! It's the magnificent world of Emacs I tell you!
...
*** WINDOW MODE
Helps with managing and adjusting windows.
#+BEGIN_SRC emacs-lisp
