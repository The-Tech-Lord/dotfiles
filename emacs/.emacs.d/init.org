...
1. Use GHCup to install Haskell compiler and HLS
   
*** Perl
**** Windows
Software: Strawberry Perl
...
* Settings
Technically, any customization that happens in this file is a "setting." To give clarity of what any customization that are under
Settings, they can be thought of as more "surface-level" customizations.
