...
I actually used to use Vim as my main editor, though, after a while I wanted to try out something different and decided to try GNU Emacs again (this being the third time). I went
with GNU Emacs because it was lightweight and wasn't resource intensive; not knowing much about its other features. Using an editor like VS Code while having a bunch of tabs open
would start to ramp up my laptop's fans. This goes back to when I was using a DELL Inspiron 15 7000 2-in-1 (Intel Core i5, Intel UHD Graphics, 8GB RAM, one cooling fan).

I'm also an organization junkie.
...
* Plasmids
I love the Bioshock series and felt like naming mode definitions after it.

** Delta
This mode is named after the main protagonist of Bioshock 2, the Big Daddy, Delta. I named this mode after Delta to be reminiscent of the Good ending route the player chooses to
traverse through (where Eleanor Lamb saves her mother from drowning and all the little sisters are alive, the ending I got). For clarity, the quote from the character Grace
Holloway, "You had me under a gun... yet you just walk away? No monster alive turns the other cheek. No monster does that. A thinking man does that."

This mode allows the usage of features that are typically included with other Word Processors (e.g., MS Word, Libre Writer). Now adays I quite prefer to use Emacs to write shit
since I've kinda become a crack addict about it now haha. I also don't wanna have to pay for MS Word (though I may still have to pay for it if I'm ever working with others) and
LibreOffice's look kinda throws me off (still very good software though!). So I thought, "why not just make that in my own config?", and here we are.
...
** Eleanor
This mode is named after the little sister that had belonged to Delta, Eleanor Lamb. I named this mode after her because if you look out the big windows of Rapture, you see a
...
user manage and adjust windows.
...
** Atlas
This mode is named after one of the main antagonists of Bioshock, Fontaine. I decided on this because he pretended that he was Atlas, therefore he perfectly fit the scenario that
this mode does, Manipulation.

This mode makes text manipulation easier and also be able to provide more varied keybindings. It'll allow movement of many sentences and paragraphs without having to use convoluted
keybindings that break your pinky.  Of course for simple manipulations, such as correcting 'theer' to 'there', would just need a simple global keybinding or manual correction.
