...
******** Begend
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "C-M-<prior>") 'beginning-of-buffer-other-window)
(global-set-key (kbd "C-M-<next>") 'end-of-buffer-other-window)
#+END_SRC
...
(global-set-key (kbd "M-SPC b") 'mark-whole-buffer)
#+END_SRC
...
(global-set-key (kbd "M-, k") 'kill-rectangle)
#+END_SRC
...
****** ExTra ExTra
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "M-, n") 'rectangle-number-lines)
