...
** Minor Mode
*** Kill Mode
The main usage of this mode is when mass deletion is needed (e.g., deleting sentences or multiple words).
#+BEGIN_SRC emacs-lisp

#+END_SRC

*** Manipulation Mode
The main usage of this mode is when mass text manipulation is need (e.g., moving around paragraphs or moving a character from one end of a word to the
other).
#+BEGIN_SRC emacs-lisp
