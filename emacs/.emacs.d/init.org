...
with GNU Emacs because it was lightweight and wasn't resource intensive; not knowing much about its other features. This goes back to when I was using a DELL Inspiron 15 7000
2-in-1 (Intel Core i5, Intel UHD Graphics, 8GB RAM, one cooling fan). Using an editor like VS Code
...
having to use convoluted keybindings that break your pinky.  Of course for simple manipulations, such as correcting 'theer' to 'there', would just need a simple global or manual
correction.
